...
contract EscrowEth {
  ...
  address payable constant lexlocker = payable(0xD476595aa1737F5FdBfE9C8FEa17737679D9f89a); //LexLocker ETH mainnet contract address
  address payable constant lexDAO = payable(0x01B92E2C0D06325089c6Fd53C98a214f5C75B2aC); //lexDAO ETH mainnet address, used below as resolver 
  address payable buyer;
  address payable seller;
  uint256 deposit;
  ...
  function _sendEscrow(string memory _description, uint256 _deposit, address payable _buyer, address payable _seller) private restricted {
