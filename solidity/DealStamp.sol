...
contract DealStamp {
  ...
  mapping(address => uint256 /*dealNumber*/) dealParty; //map whether an address is a party to the indexed deal
  ...
  // @param _dealNumber: provide "ID" dealNumber to view stamped deal information
