...
contract DealStamp {
    ...
    mapping(uint256 /*dealNumber*/ => string) docsLocation; // deal doc storage location - may be encrypted on the client side
    ...
    function newDealStamp(
      ...
      return(dealNumber - 1); // DealStamper should record the dealNumber for this function call for relevant parties
    }
