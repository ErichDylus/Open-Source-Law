...
contract TaxPayment {
    ...
    /// @param _taxRate percentage tax rate as a nonzero uint < 1000 to allow for one decimal place. 50 = 5%, 5 = 0.5%, etc.
        ...
        returns (uint256, uint256)
    {
        ...
        taxPaymentNumberAmount[_taxes][msg.sender] = taxPaymentNumber[
            msg.sender
        ];
        emit TaxPaid(
            msg.sender,
